...
public final class FindMeetingQueryTest {
  ...
  //    Additional test cases for optional attendee functionality
  // ***************************************************************

  @Test
  public void optionalAttendeeTooBusy() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Events  :       |--A--|     |--B--|
  ...
  @Test
  public void optionalAttendeeNotTooBusy() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Events  :       |--A--|     |--B--|
  ...
  @Test
  public void justEnoughRoomWithAttendeeB() {
    // Have one person, but make it so that there is just enough room at one point in the day to
    // have the meeting.
    //
    // Events  : |--A--|-B|  |----A----|
  ...
  public void unavailableOptionalAttendees() {
    ...
    Collection<TimeRange> expected =
        Arrays.asList(
            ...
            TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_0845AM, false));
  ...
  If no time exists for all optional and mandatory attendees, find the
